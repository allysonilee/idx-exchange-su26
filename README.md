...
|---|---|
| Price Dashboard | Monthly median close price, Average close-to-original-list price ratio |
| List & Sale Dashboard | New listings, Closed sales, Average days on market |
| Geo Dashboard | Price per sqft by geography |
## Directory (updated to Week 9)
```
├── README.md
│
